          ...
          Card(
            child: Padding(
              ...
              child: SwitchListTile(
                ...
                subtitle:
                    Text(_notificationsEnabled ? 'Включены' : 'Выключены'),
                ...
                secondary: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        (_notificationsEnabled ? AppTheme.accent : Colors.grey)
                            .withOpacity(0.1),
          ...
          if (_notificationsEnabled) ...[
            ...
            Card(
              child: Column(
                children: [
                  SwitchListTile(
                    title: const Text('Срочные новости',
                        style: TextStyle(fontWeight: FontWeight.w600)),
                    subtitle:
                        const Text('Мгновенные оповещения о важных событиях'),
                    value: _breakingNews,
                  ...
                  SwitchListTile(
                    title: const Text('Ежедневный дайджест',
                        style: TextStyle(fontWeight: FontWeight.w600)),
                  ...
                  const Divider(height: 1, indent: 72),
                  SwitchListTile(
                    title: const Text('Еженедельный обзор',
                        style: TextStyle(fontWeight: FontWeight.w600)),
